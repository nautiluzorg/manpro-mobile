...
class RunningProvider extends ChangeNotifier {
  ...
  Future<bool> postPending(
    ...
    try {
      ...
      print("=== DEBUG POST PENDING ===");
      print("selectedReason.idReason: ${selectedReason.idReason}");
      selectedItems.forEach((item) {
        print(
            "bcode: ${item.detailsRecord.isNotEmpty ? item.detailsRecord[0].bcode : 'KOSONG'}");
        print("idProses: ${item.idProses}");
        print("idEmployee: ${item.activeEmployee?.idEmployee}");
      });
      print("==========================");
      ...
      print("postPendingRecords result: $success");
