...
// TAMBAHAN: global navigator key, dipakai auth_interceptor buat navigasi
// tanpa butuh BuildContext (interceptor bukan widget)
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<TestingProvider>(
          create: (_) => TestingProvider(TestingService()),
        ),
