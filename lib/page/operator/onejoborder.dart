...
// import 'package:flutter_provider_data/widget/focus_glow.dart'; // REMOVED unused
// import 'package:flutter_provider_data/widget/glass_style.dart'; // REMOVED unused
// import 'package:flutter_provider_data/widget/glass_wrapper.dart'; // REMOVED unused
...
class OneJoborder extends StatefulWidget {
  final String title;
  ...
  @override
  State<OneJoborder> createState() => _OneJoborderState();
}

class _OneJoborderState extends State<OneJoborder>
  ...
  Widget build(BuildContext context) {
    ...
    double conTextfieldHeight =
        isTablet ? heightBody * 0.18 : heightBody * 0.55;
  ...
  Widget _buildTextField({
    ...
    Widget? suffixIcon,
    FocusNode? focusNode, // 🔥 OPTIONAL (untuk FocusGlow / auto focus)
  }) {
    ...
    return Padding(
      ...
      child: TextField(
        ...
        focusNode: focusNode, // 🔥 inject focus node
        readOnly: readOnly,
                                      ...
                                      ? () {
                                          ...
                                          if (selectedItem != null) {
                                            setState(() {
                                              idMachineController.text =
                                                  selectedItem.idMc;
                                              areaMachine = selectedItem.areaMc;
                                              typeMachine =
                                                  selectedItem.categoryMc;
                                              jobProcess = "MOULDING";
