      ...
      child: Stack(
        children: [
          AnimatedContainer(
            ...
            // Bagian konten (judul, foto, nama, tabel) dibungkus Expanded +
            // SingleChildScrollView, supaya kalau tingginya lebih dari sisa
            // ruang yang ada, dia scroll (aman, gak overflow). Tombol
            // STOP/FINISH ditaruh DI LUAR Expanded ini, jadi posisinya
            // SELALU konsisten di semua card — karena GridView sendiri
            // sudah menyamakan tinggi tiap cell, Expanded akan selalu
            // mengisi sisa ruang yang sama persis, dan tombol selalu
            // menempel tepat setelahnya, gak lagi ikut naik-turun
            // tergantung panjang konten di atasnya.
            child: Column(
              ...
              children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                ...
                                BoxShadow(
                                  color:
                                      Colors.blueAccent.withValues(alpha: 40),
                                  blurRadius: 15,
                                  spreadRadius: 3,
                                ),
                                BoxShadow(
                ...
                // Buttons — selalu di luar Expanded, jadi posisinya
                // konsisten di semua card, gak ikut naik-turun.
                Row(
                  children: [
                    Expanded(
