...
class TestingCompleted extends StatefulWidget {
  final String title;
...
class _TestingCompletedState extends State<TestingCompleted> {
  ...
  Future<PaginatedTestingCompleted> fetchCompletedDataFuture({
    int page = 1,
    int pageSize = 20,
    String? jobNumber,
    ...
    final uri = Uri.parse('${AppConfig.baseUrl}/api/completed-testing/')
    ...
    if (response.statusCode == 200) {
      ...
      return PaginatedTestingCompleted.fromJson(jsonData);
    } else {
            ...
            onPressed: () {
              Navigator.pushReplacement(
                ...
                PageRouteBuilder(
                  pageBuilder: (context, animation, secondaryAnimation) =>
                      MenuSubTesting(
                          title: "MOLD TESTING", idProses: widget.idProses),
                  transitionsBuilder:
                  ...
                  child: OrientationBuilder(
                    builder: (context, orientation) {
                      ...
                      final children = [
                        ...
                        SizedBox(
                          width: screenWidth * 0.23, // 15% dari lebar layar
                          child: Container(
                            decoration: BoxDecoration(
                        ...
                        SizedBox(width: screenWidth * 0.02), // spacing 2% layar
                            ...
                            return Container(
                              ...
                              child: Row(children: [
                                Container(
                                  ...
                                  child: StatusBadge(record.status.toString()),
                                ),
                                Padding(
                                      ...
                                      children: [
                                        CircleAvatar(
                                          ...
                                          backgroundImage: NetworkImage(
                                              '${AppConfig.baseUrl}/media/img/employee/${record.employeeId}.png'),
                                ...
                                Container(
                                    ...
                                    alignment: Alignment.centerLeft,
                                    child:
                                        Text(record.totalJobNumber.toString())),
                                Container(
                                  width: 200,
                                  height: 48,
                                  alignment: Alignment.centerLeft,
                                ...
                                Container(
                                    ...
                                    height: 48,
                                    alignment: Alignment.centerLeft,
                                    child: Text(record.moldNumber.toString(),
                                        style: TextStyle(
                                ...
                                Container(
                                    ...
                                    height: 48,
                                    alignment: Alignment.centerLeft,
                                    child: Text(record.moldCavity.toString())),
                                Container(
                                    width: 120,
                                    height: 48,
                                    alignment: Alignment.centerLeft,
...
class StatusBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Tentukan warna dan teks sesuai status
    Color bgColor;
    String displayText;
