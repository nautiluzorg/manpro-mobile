                                    ...
                                    child: Ink(
                                      ...
                                      child: OutlinedButton.icon(
                                        ...
                                        onPressed: () async {
                                          ...
                                          // Validasi METAL PILL
                                          if (jobProvider.productCategory ==
                                              "METAL PILL") {
                                            // Jika ID 0 dianggap kosong/tidak ada
                                            final goldId = materialProvider
                                                        .goldPillData.id ==
                                                    0
                                                ? ""
                                                : materialProvider
                                          ...
                                          jobProvider.idEmployee =
                                              idEmployeeController.text.trim();
                                          jobProvider.idMachine =
                                              idMachineController.text.trim();

                                          jobProvider.setSubmitting(
                                              true); // tombol disable

                                          try {
                                            bool isSuccess =
                                                await jobProvider.submitRecord(
                                                    ngProvider, context);
