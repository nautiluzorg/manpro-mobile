...
class RecordPendingDetailModel extends Equatable {
  ...
  factory RecordPendingDetailModel.fromJson(
    ...
    return RecordPendingDetailModel(
      ...
      lastOperatorName: json['last_operator_name']?.toString(),

      lastQtyShoot: json.safeInt('last_qty_shoot'),

      // NG
      ngList: json.safeList(
        'ng_list',
        (e) => NgOperatorModel.fromJson(
  ...
  RecordPendingDetailModel copyWith({
    ...
    return RecordPendingDetailModel(
      ...
      lastOperatorName: lastOperatorName ?? this.lastOperatorName,
      lastQtyShoot: lastQtyShoot ?? this.lastQtyShoot,
